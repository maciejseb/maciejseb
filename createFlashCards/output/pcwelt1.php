...
<script> 
worlds = [];
worlds[0] = ["ohne vorherige Benachrichtigung.","bez uprzedniego powiadomienia."];
worlds[1] = ["jdn über etw benachrichtigen.","powiadomić kogoś o czymś."];
worlds[2] = ["Aufnehmen.","Podejmować."];
worlds[3] = ["Und seine Kleidung. . sogar in Schwarz-Weiß war sie atemberaubend.","A jego ubranie... nawet w czerni i bieli to ubranie było oszałamiające."];
worlds[4] = ["sich am Treppengeländer festhalten.","trzymać się poręczy schodów."];
worlds[5] = ["Nicht, dass ihr Mann es mitbekommt.","Nie chciałbyś, żeby jej facet cię podsłuchał."];
worlds[6] = ["Jegliche.","każdy · wszelki."];
worlds[7] = ["neu erstellen.","sporządzać ponownie."];
worlds[8] = ["Selbstlöschend.","Samogasnący."];
worlds[9] = [" selbstlöschenden Nachrichten.","wiadomości samoczynnie usuwane."];
